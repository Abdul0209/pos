...
<tbody></tbody>
  ...
  <div class="col-md-8">
     <div id="tampil-bayar" style="background: #dd4b39; color: #fff; font-size: 45px; text-align: center; height: 90px"></div>
     <div id="tampil-terbilang" style="background: #3c8dbc; color: #fff; font-size: 50px; text-align:center; height: 90px"></div>
  </div>
  <div class="col-md-4">
    <form class="form form-horizontal form-penjualan" method="post" action="transaksi/simpan">
      ...
      <div class="form-group">
        <label for="totalrp" class="col-md-4 control-label">Harga Total</label>
        <div class="col-md-8">
      ...
      <div class="form-group">
        <label for="bayarrp" class="col-md-4 control-label">Dibayar</label>
        <div class="col-md-8">
      ...
      <div class="form-group">
        <label for="diterima" class="col-md-4 control-label">Uang Dibayar Sebesar</label>
        <div class="col-md-8">
      ...
      <div class="form-group">
        <label for="kembali" class="col-md-4 control-label">Kembalian</label>
        <div class="col-md-8">
